...
class UserLoginForm extends FormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['actions']['submit'] = ['#type' => 'submit', '#value' => $this->t('Iniciar sesión')];
  ...
  public function validateFinal(array &$form, FormStateInterface $form_state) {
    ...
    if (!$form_state->get('uid')) {
      ...
      if ($flood_control_triggered = $form_state->get('flood_control_triggered')) {
        ...
        $form_state->setErrorByName('name', $this->t('Nombre de usuario o contraseña no reconocidos. <a href=":password">¿Olvidaste tu contraseña?</a>', [':password' => Url::fromRoute('user.pass', [], ['query' => $query])->toString()]));
