...
class UserPasswordForm extends FormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    $form['name'] = [
      ...
      '#title' => $this->t('Nombre de usuario o email'),
      '#size' => 60,
    ...
    if ($user->isAuthenticated()) {
      ...
      $form['mail'] = [
        ...
        '#markup' => $this->t('Las instrucciones de reseteo de contraseña se enviarán al email con el que te registraste.'),
        '#suffix' => '</p>',
      ];
    ...
    $form['actions']['submit'] = ['#type' => 'submit', '#value' => $this->t('Enviar')];
