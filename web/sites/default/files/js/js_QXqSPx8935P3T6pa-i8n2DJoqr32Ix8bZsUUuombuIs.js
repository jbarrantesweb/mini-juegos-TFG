...
docReady(function () {
  ...
  tablero.innerHTML += "<br /><br />Pulsa <span id='jugar1' class='clickable rojo'>PLAY</span> <br /> para jugar";
  ...
  function jugar() {
    ...
    tiempo = 5000; //tiene que disminuir para ser más rapido y complicar el juego
