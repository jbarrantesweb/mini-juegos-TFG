...
//document ready
docReady(function () {
  var container = document.querySelector("#block-bloquejuego .content");
  ...
  tablero.innerHTML += "Pulsa <button id='mi-boton' class='clickable rojo'>PLAY</button> para jugar";
  document.getElementById("mi-boton").addEventListener("click", jugar);
  ...
  function jugar() {
    ...
    $("#botones").show();
    $("#marcador").show();
    $("#status").show(); //mostramos la barra
    */
    ...
    puntos.innerText = "Puntuación " + puntuacion; //puntuación a cero
  ...
  function gameOver() {
    ...
    tablero.innerHTML += "Puntuación: " + puntuacion + "<br />";
    tablero.innerHTML += "<span onclick='jugar()' class='clickable text-danger'>Jugar de nuevo??</span>";
    mostrar_play();
